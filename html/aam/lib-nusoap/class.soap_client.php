...
/**
*
* [nu]soap_client higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soap_client = new nusoap_client( string path [ ,mixed wsdl] );
*
...
* @version  $Id: class.soap_client.php,v 1.69 2010/04/26 20:15:08 snichol Exp $
* @access   public
*/
